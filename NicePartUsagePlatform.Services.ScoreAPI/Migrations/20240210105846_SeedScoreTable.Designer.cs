...
namespace NicePartUsagePlatform.Services.ScoreAPI.Migrations
{
    ...
    [Migration("20240210105846_SeedScoreTable")]
    partial class SeedScoreTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NicePartUsagePlatform.Services.ScoreAPI.Models.Score", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ScoreId = 1,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 2, 10, 11, 58, 46, 263, DateTimeKind.Unspecified).AddTicks(8540), new TimeSpan(0, 1, 0, 0, 0)),
                            Creativity = 8,
                            NpuId = 1,
                            Uniqueness = 7,
                            UserId = 1
